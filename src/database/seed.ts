...
const LEVELS_DATA = [
  ...
  { level_number: 9, name: 'Common Words & Concepts', 
    description: 'Essential verbs and time concepts' },
  { level_number: 10, name: 'Travel & Transport', 
    description: 'Transportation and travel vocabulary' },
  { level_number: 11, name: 'Work & School', 
    description: 'Professional and educational terms' },
  { level_number: 12, name: 'Hobbies & Leisure', 
...
const WORDS_DATA = [
  ...
  { french: 'déménager', english: 'to move', word_type: 'verb', 
    level: 8, gender: null },
  { french: 'installer', english: 'to install', word_type: 'verb', 
    level: 8, gender: null },

  // Level 9: Common Words & Concepts
  { french: 'le nombre', english: 'number', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'le matin', english: 'morning', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'l\'après-midi', english: 'afternoon', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'le soir', english: 'evening', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'la fleur', english: 'flower', word_type: 'noun', 
    level: 9, gender: 'la' },
  { french: 'l\'arbre', english: 'tree', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'l\'animal', english: 'animal', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'le numéro', english: 'number', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'l\'heure', english: 'hour', word_type: 'noun', 
    level: 9, gender: 'la' },
  { french: 'le téléphone', english: 'phone', word_type: 'noun', 
    level: 9, gender: 'le' },
  { french: 'dire', english: 'to say', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'devoir', english: 'to have to', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'vouloir', english: 'to want', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'pouvoir', english: 'to be able to', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'savoir', english: 'to know', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'tenir', english: 'to hold', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'croire', english: 'to believe', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'sembler', english: 'to seem', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'demander', english: 'to ask', word_type: 'verb', 
    level: 9, gender: null },
  { french: 'penser', english: 'to think', word_type: 'verb', 
    level: 9, gender: null },

  // Level 10: Travel & Transport
  ...
  { french: 'arriver', english: 'to arrive', word_type: 'verb', 
    level: 10, gender: null },
  { french: 'explorer', english: 'to explore', word_type: 'verb', 
    level: 10, gender: null },
  ...
  { french: 'réussir', english: 'to succeed', word_type: 'verb', 
    level: 11, gender: null },
  { french: 'organiser', english: 'to organize', word_type: 'verb', 
    level: 11, gender: null },
  { french: 'créer', english: 'to create', word_type: 'verb', 
    level: 11, gender: null },

  // Level 12: Hobbies & Leisure
...
function seedDatabase() {
  ...
  try {
    ...
    const exampleSentences = [
      ...
      // Level 8: Home & Furniture
      { word: 'la chambre', sentences: [
        { fr: 'Ma chambre est grande.', en: 'My bedroom is big.', 
          replace: 'chambre' },
        { fr: 'Il dort dans sa chambre.', en: 'He sleeps in his bedroom.', 
          replace: 'chambre' },
        { fr: 'Elle range sa chambre.', en: 'She tidies her bedroom.', 
          replace: 'chambre' },
        { fr: 'Ils dorment dans leurs chambres.', en: 'They sleep in their bedrooms.', 
          replace: 'chambres' },
        { fr: 'Nous avons une belle chambre.', en: 'We have a beautiful bedroom.', 
          replace: 'chambre' },
        { fr: 'Vous aimez votre chambre?', en: 'Do you like your bedroom?', 
          replace: 'chambre' }
      ]},
      { word: 'le salon', sentences: [
        { fr: 'Le salon est confortable.', en: 'The living room is comfortable.', 
          replace: 'salon' },
        { fr: 'Il regarde la télé dans le salon.', en: 'He watches TV in the living room.', 
          replace: 'salon' },
        { fr: 'Elle lit dans le salon.', en: 'She reads in the living room.', 
          replace: 'salon' },
        { fr: 'Ils jouent dans le salon.', en: 'They play in the living room.', 
          replace: 'salon' },
        { fr: 'Nous nous détendons dans le salon.', en: 'We relax in the living room.', 
          replace: 'salon' },
        { fr: 'Vous recevez dans le salon.', en: 'You entertain in the living room.', 
          replace: 'salon' }
      ]},
      { word: 'la salle', sentences: [
        { fr: 'Cette salle est grande.', en: 'This room is big.', 
          replace: 'salle' },
        { fr: 'Il nettoie la salle.', en: 'He cleans the room.', 
          replace: 'salle' },
        { fr: 'Elle décore la salle.', en: 'She decorates the room.', 
          replace: 'salle' },
        { fr: 'Ils utilisent cette salle.', en: 'They use this room.', 
          replace: 'salle' },
        { fr: 'Nous organisons la salle.', en: 'We organize the room.', 
          replace: 'salle' },
        { fr: 'Vous préférez quelle salle?', en: 'Which room do you prefer?', 
          replace: 'salle' }
      ]},
      { word: 'le mur', sentences: [
        { fr: 'Le mur est blanc.', en: 'The wall is white.', 
          replace: 'mur' },
        { fr: 'Il peint le mur.', en: 'He paints the wall.', 
          replace: 'mur' },
        { fr: 'Elle accroche un tableau au mur.', en: 'She hangs a painting on the wall.', 
          replace: 'mur' },
        { fr: 'Ils construisent un mur.', en: 'They build a wall.', 
          replace: 'mur' },
        { fr: 'Nous réparons le mur.', en: 'We repair the wall.', 
          replace: 'mur' },
        { fr: 'Vous touchez le mur.', en: 'You touch the wall.', 
          replace: 'mur' }
      ]},
      { word: 'la fenêtre', sentences: [
        { fr: 'La fenêtre est ouverte.', en: 'The window is open.', 
          replace: 'fenêtre' },
        { fr: 'Il ferme la fenêtre.', en: 'He closes the window.', 
          replace: 'fenêtre' },
        { fr: 'Elle regarde par la fenêtre.', en: 'She looks out the window.', 
          replace: 'fenêtre' },
        { fr: 'Ils ouvrent les fenêtres.', en: 'They open the windows.', 
          replace: 'fenêtres' },
        { fr: 'Nous nettoyons la fenêtre.', en: 'We clean the window.', 
          replace: 'fenêtre' },
        { fr: 'Vous aérez par la fenêtre.', en: 'You air out through the window.', 
          replace: 'fenêtre' }
      ]},
      { word: 'le toit', sentences: [
        { fr: 'Le toit est rouge.', en: 'The roof is red.', 
          replace: 'toit' },
        { fr: 'Il répare le toit.', en: 'He repairs the roof.', 
          replace: 'toit' },
        { fr: 'Elle monte sur le toit.', en: 'She climbs onto the roof.', 
          replace: 'toit' },
        { fr: 'Ils construisent le toit.', en: 'They build the roof.', 
          replace: 'toit' },
        { fr: 'Nous regardons le toit.', en: 'We look at the roof.', 
          replace: 'toit' },
        { fr: 'Vous voyez le toit?', en: 'Do you see the roof?', 
          replace: 'toit' }
      ]},
      { word: 'le meuble', sentences: [
        { fr: 'Ce meuble est ancien.', en: 'This furniture is old.', 
          replace: 'meuble' },
        { fr: 'Il achète un nouveau meuble.', en: 'He buys new furniture.', 
          replace: 'meuble' },
        { fr: 'Elle range le meuble.', en: 'She tidies the furniture.', 
          replace: 'meuble' },
        { fr: 'Ils déplacent les meubles.', en: 'They move the furniture.', 
          replace: 'meubles' },
        { fr: 'Nous choisissons les meubles.', en: 'We choose the furniture.', 
          replace: 'meubles' },
        { fr: 'Vous aimez ces meubles?', en: 'Do you like this furniture?', 
          replace: 'meubles' }
      ]},
      { word: 'le canapé', sentences: [
        { fr: 'Le canapé est confortable.', en: 'The sofa is comfortable.', 
          replace: 'canapé' },
        { fr: 'Il s\'assoit sur le canapé.', en: 'He sits on the sofa.', 
          replace: 'canapé' },
        { fr: 'Elle dort sur le canapé.', en: 'She sleeps on the sofa.', 
          replace: 'canapé' },
        { fr: 'Ils regardent la télé sur le canapé.', en: 'They watch TV on the sofa.', 
          replace: 'canapé' },
        { fr: 'Nous achetons un nouveau canapé.', en: 'We buy a new sofa.', 
          replace: 'canapé' },
        { fr: 'Vous préférez le canapé?', en: 'Do you prefer the sofa?', 
          replace: 'canapé' }
      ]},
      { word: 'l\'armoire', sentences: [
        { fr: 'L\'armoire est pleine.', en: 'The wardrobe is full.', 
          replace: 'armoire' },
        { fr: 'Il ouvre l\'armoire.', en: 'He opens the wardrobe.', 
          replace: 'armoire' },
        { fr: 'Elle range ses vêtements dans l\'armoire.', en: 'She puts her clothes in the wardrobe.', 
          replace: 'armoire' },
        { fr: 'Ils achètent une nouvelle armoire.', en: 'They buy a new wardrobe.', 
          replace: 'armoire' },
        { fr: 'Nous fermons l\'armoire.', en: 'We close the wardrobe.', 
          replace: 'armoire' },
        { fr: 'Vous cherchez dans l\'armoire?', en: 'Are you looking in the wardrobe?', 
          replace: 'armoire' }
      ]},
      { word: 'le miroir', sentences: [
        { fr: 'Le miroir est cassé.', en: 'The mirror is broken.', 
          replace: 'miroir' },
        { fr: 'Il se regarde dans le miroir.', en: 'He looks at himself in the mirror.', 
          replace: 'miroir' },
        { fr: 'Elle se maquille devant le miroir.', en: 'She puts on makeup in front of the mirror.', 
          replace: 'miroir' },
        { fr: 'Ils accrochent le miroir.', en: 'They hang the mirror.', 
          replace: 'miroir' },
        { fr: 'Nous nettoyons le miroir.', en: 'We clean the mirror.', 
          replace: 'miroir' },
        { fr: 'Vous voyez votre reflet dans le miroir.', en: 'You see your reflection in the mirror.', 
          replace: 'miroir' }
      ]},
      { word: 'ouvrir', sentences: [
        { fr: 'J\'ouvre la porte.', en: 'I open the door.', 
          replace: 'ouvre' },
        { fr: 'Il ouvre la fenêtre.', en: 'He opens the window.', 
          replace: 'ouvre' },
        { fr: 'Elle ouvre le livre.', en: 'She opens the book.', 
          replace: 'ouvre' },
        { fr: 'Ils ouvrent les cadeaux.', en: 'They open the gifts.', 
          replace: 'ouvrent' },
        { fr: 'Nous ouvrons la boutique.', en: 'We open the shop.', 
          replace: 'ouvrons' },
        { fr: 'Vous ouvrez à quelle heure?', en: 'What time do you open?', 
          replace: 'ouvrez' }
      ]},
      { word: 'fermer', sentences: [
        { fr: 'Je ferme la porte.', en: 'I close the door.', 
          replace: 'ferme' },
        { fr: 'Il ferme les yeux.', en: 'He closes his eyes.', 
          replace: 'ferme' },
        { fr: 'Elle ferme le magasin.', en: 'She closes the store.', 
          replace: 'ferme' },
        { fr: 'Ils ferment les fenêtres.', en: 'They close the windows.', 
          replace: 'ferment' },
        { fr: 'Nous fermons à huit heures.', en: 'We close at eight o\'clock.', 
          replace: 'fermons' },
        { fr: 'Vous fermez la porte?', en: 'Do you close the door?', 
          replace: 'fermez' }
      ]},
      { word: 'ranger', sentences: [
        { fr: 'Je range ma chambre.', en: 'I tidy my room.', 
          replace: 'range' },
        { fr: 'Il range ses affaires.', en: 'He tidies his things.', 
          replace: 'range' },
        { fr: 'Elle range la cuisine.', en: 'She tidies the kitchen.', 
          replace: 'range' },
        { fr: 'Ils rangent leurs jouets.', en: 'They tidy their toys.', 
          replace: 'rangent' },
        { fr: 'Nous rangeons ensemble.', en: 'We tidy together.', 
          replace: 'rangeons' },
        { fr: 'Vous rangez bien.', en: 'You tidy well.', 
          replace: 'rangez' }
      ]},
      { word: 'décorer', sentences: [
        { fr: 'Je décore la maison.', en: 'I decorate the house.', 
          replace: 'décore' },
        { fr: 'Il décore le sapin.', en: 'He decorates the Christmas tree.', 
          replace: 'décore' },
        { fr: 'Elle décore sa chambre.', en: 'She decorates her room.', 
          replace: 'décore' },
        { fr: 'Ils décorent la salle.', en: 'They decorate the room.', 
          replace: 'décorent' },
        { fr: 'Nous décorons pour Noël.', en: 'We decorate for Christmas.', 
          replace: 'décorons' },
        { fr: 'Vous décorez souvent?', en: 'Do you decorate often?', 
          replace: 'décorez' }
      ]},
      { word: 'construire', sentences: [
        { fr: 'Je construis une maison.', en: 'I build a house.', 
          replace: 'construis' },
        { fr: 'Il construit un château.', en: 'He builds a castle.', 
          replace: 'construit' },
        { fr: 'Elle construit un pont.', en: 'She builds a bridge.', 
          replace: 'construit' },
        { fr: 'Ils construisent des routes.', en: 'They build roads.', 
          replace: 'construisent' },
        { fr: 'Nous construisons ensemble.', en: 'We build together.', 
          replace: 'construisons' },
        { fr: 'Vous construisez quoi?', en: 'What do you build?', 
          replace: 'construisez' }
      ]},
      { word: 'réparer', sentences: [
        { fr: 'Je répare la voiture.', en: 'I repair the car.', 
          replace: 'répare' },
        { fr: 'Il répare l\'ordinateur.', en: 'He repairs the computer.', 
          replace: 'répare' },
        { fr: 'Elle répare le vélo.', en: 'She repairs the bike.', 
          replace: 'répare' },
        { fr: 'Ils réparent les meubles.', en: 'They repair the furniture.', 
          replace: 'réparent' },
        { fr: 'Nous réparons tout.', en: 'We repair everything.', 
          replace: 'réparons' },
        { fr: 'Vous réparez bien.', en: 'You repair well.', 
          replace: 'réparez' }
      ]},
      { word: 'peindre', sentences: [
        { fr: 'Je peins un tableau.', en: 'I paint a painting.', 
          replace: 'peins' },
        { fr: 'Il peint la maison.', en: 'He paints the house.', 
          replace: 'peint' },
        { fr: 'Elle peint des fleurs.', en: 'She paints flowers.', 
          replace: 'peint' },
        { fr: 'Ils peignent les murs.', en: 'They paint the walls.', 
          replace: 'peignent' },
        { fr: 'Nous peignons ensemble.', en: 'We paint together.', 
          replace: 'peignons' },
        { fr: 'Vous peignez souvent?', en: 'Do you paint often?', 
          replace: 'peignez' }
      ]},
      { word: 'louer', sentences: [
        { fr: 'Je loue un appartement.', en: 'I rent an apartment.', 
          replace: 'loue' },
        { fr: 'Il loue une voiture.', en: 'He rents a car.', 
          replace: 'loue' },
        { fr: 'Elle loue un film.', en: 'She rents a movie.', 
          replace: 'loue' },
        { fr: 'Ils louent une maison.', en: 'They rent a house.', 
          replace: 'louent' },
        { fr: 'Nous louons pour les vacances.', en: 'We rent for vacation.', 
          replace: 'louons' },
        { fr: 'Vous louez où?', en: 'Where do you rent?', 
          replace: 'louez' }
      ]},
      { word: 'déménager', sentences: [
        { fr: 'Je déménage demain.', en: 'I move tomorrow.', 
          replace: 'déménage' },
        { fr: 'Il déménage à Paris.', en: 'He moves to Paris.', 
          replace: 'déménage' },
        { fr: 'Elle déménage souvent.', en: 'She moves often.', 
          replace: 'déménage' },
        { fr: 'Ils déménagent ensemble.', en: 'They move together.', 
          replace: 'déménagent' },
        { fr: 'Nous déménageons ce week-end.', en: 'We move this weekend.', 
          replace: 'déménageons' },
        { fr: 'Vous déménagez quand?', en: 'When do you move?', 
          replace: 'déménagez' }
      ]},
      { word: 'installer', sentences: [
        { fr: 'J\'installe un logiciel.', en: 'I install software.', 
          replace: 'installe' },
        { fr: 'Il installe la télévision.', en: 'He installs the television.', 
          replace: 'installe' },
        { fr: 'Elle installe des étagères.', en: 'She installs shelves.', 
          replace: 'installe' },
        { fr: 'Ils installent l\'électricité.', en: 'They install electricity.', 
          replace: 'installent' },
        { fr: 'Nous installons demain.', en: 'We install tomorrow.', 
          replace: 'installons' },
        { fr: 'Vous installez quoi?', en: 'What do you install?', 
          replace: 'installez' }
      ]},

      // Level 9: Common Words & Concepts
      { word: 'le nombre', sentences: [
        { fr: 'Le nombre est grand.', en: 'The number is large.', 
          replace: 'nombre' },
        { fr: 'Il compte les nombres.', en: 'He counts the numbers.', 
          replace: 'nombres' },
        { fr: 'Elle écrit un nombre.', en: 'She writes a number.', 
          replace: 'nombre' },
        { fr: 'Ils connaissent ce nombre.', en: 'They know this number.', 
          replace: 'nombre' },
        { fr: 'Nous voyons le nombre.', en: 'We see the number.', 
          replace: 'nombre' },
        { fr: 'Vous avez ce nombre?', en: 'Do you have this number?', 
          replace: 'nombre' }
      ]},
      { word: 'le matin', sentences: [
        { fr: 'Le matin est beau.', en: 'The morning is beautiful.', 
          replace: 'matin' },
        { fr: 'Il arrive le matin.', en: 'He arrives in the morning.', 
          replace: 'matin' },
        { fr: 'Elle travaille le matin.', en: 'She works in the morning.', 
          replace: 'matin' },
        { fr: 'Ils partent le matin.', en: 'They leave in the morning.', 
          replace: 'matin' },
        { fr: 'Nous mangeons le matin.', en: 'We eat in the morning.', 
          replace: 'matin' },
        { fr: 'Vous êtes là le matin?', en: 'Are you there in the morning?', 
          replace: 'matin' }
      ]},
      { word: 'l\'après-midi', sentences: [
        { fr: 'L\'après-midi est chaud.', en: 'The afternoon is hot.', 
          replace: 'après-midi' },
        { fr: 'Il finit l\'après-midi.', en: 'He finishes in the afternoon.', 
          replace: 'après-midi' },
        { fr: 'Elle joue l\'après-midi.', en: 'She plays in the afternoon.', 
          replace: 'après-midi' },
        { fr: 'Ils étudient l\'après-midi.', en: 'They study in the afternoon.', 
          replace: 'après-midi' },
        { fr: 'Nous nous reposons l\'après-midi.', en: 'We rest in the afternoon.', 
          replace: 'après-midi' },
        { fr: 'Vous venez l\'après-midi?', en: 'Do you come in the afternoon?', 
          replace: 'après-midi' }
      ]},
      { word: 'le soir', sentences: [
        { fr: 'Le soir est calme.', en: 'The evening is calm.', 
          replace: 'soir' },
        { fr: 'Il rentre le soir.', en: 'He returns in the evening.', 
          replace: 'soir' },
        { fr: 'Elle dîne le soir.', en: 'She dines in the evening.', 
          replace: 'soir' },
        { fr: 'Ils regardent le soir.', en: 'They watch in the evening.', 
          replace: 'soir' },
        { fr: 'Nous dormons le soir.', en: 'We sleep in the evening.', 
          replace: 'soir' },
        { fr: 'Vous sortez le soir?', en: 'Do you go out in the evening?', 
          replace: 'soir' }
      ]},
      { word: 'la fleur', sentences: [
        { fr: 'La fleur est rouge.', en: 'The flower is red.', 
          replace: 'fleur' },
        { fr: 'Il cueille la fleur.', en: 'He picks the flower.', 
          replace: 'fleur' },
        { fr: 'Elle sent la fleur.', en: 'She smells the flower.', 
          replace: 'fleur' },
        { fr: 'Ils voient les fleurs.', en: 'They see the flowers.', 
          replace: 'fleurs' },
        { fr: 'Nous donnons la fleur.', en: 'We give the flower.', 
          replace: 'fleur' },
        { fr: 'Vous aimez la fleur?', en: 'Do you like the flower?', 
          replace: 'fleur' }
      ]},
      { word: 'l\'arbre', sentences: [
        { fr: 'L\'arbre est grand.', en: 'The tree is tall.', 
          replace: 'arbre' },
        { fr: 'Il voit l\'arbre.', en: 'He sees the tree.', 
          replace: 'arbre' },
        { fr: 'Elle plante l\'arbre.', en: 'She plants the tree.', 
          replace: 'arbre' },
        { fr: 'Ils touchent l\'arbre.', en: 'They touch the tree.', 
          replace: 'arbre' },
        { fr: 'Nous aimons l\'arbre.', en: 'We like the tree.', 
          replace: 'arbre' },
        { fr: 'Vous regardez l\'arbre?', en: 'Do you look at the tree?', 
          replace: 'arbre' }
      ]},
      { word: 'l\'animal', sentences: [
        { fr: 'L\'animal est petit.', en: 'The animal is small.', 
          replace: 'animal' },
        { fr: 'Il aime l\'animal.', en: 'He likes the animal.', 
          replace: 'animal' },
        { fr: 'Elle nourrit l\'animal.', en: 'She feeds the animal.', 
          replace: 'animal' },
        { fr: 'Ils voient l\'animal.', en: 'They see the animal.', 
          replace: 'animal' },
        { fr: 'Nous soignons l\'animal.', en: 'We care for the animal.', 
          replace: 'animal' },
        { fr: 'Vous avez l\'animal?', en: 'Do you have the animal?', 
          replace: 'animal' }
      ]},
      { word: 'le numéro', sentences: [
        { fr: 'Le numéro est bon.', en: 'The number is good.', 
          replace: 'numéro' },
        { fr: 'Il compose le numéro.', en: 'He dials the number.', 
          replace: 'numéro' },
        { fr: 'Elle a le numéro.', en: 'She has the number.', 
          replace: 'numéro' },
        { fr: 'Ils cherchent le numéro.', en: 'They look for the number.', 
          replace: 'numéro' },
        { fr: 'Nous appelons le numéro.', en: 'We call the number.', 
          replace: 'numéro' },
        { fr: 'Vous connaissez le numéro?', en: 'Do you know the number?', 
          replace: 'numéro' }
      ]},
      { word: 'l\'heure', sentences: [
        { fr: 'L\'heure est venue.', en: 'The time has come.', 
          replace: 'heure' },
        { fr: 'Il regarde l\'heure.', en: 'He looks at the time.', 
          replace: 'heure' },
        { fr: 'Elle arrive à l\'heure.', en: 'She arrives on time.', 
          replace: 'heure' },
        { fr: 'Ils passent l\'heure.', en: 'They spend the hour.', 
          replace: 'heure' },
        { fr: 'Nous prenons l\'heure.', en: 'We take the time.', 
          replace: 'heure' },
        { fr: 'Vous avez l\'heure?', en: 'Do you have the time?', 
          replace: 'heure' }
      ]},
      { word: 'le téléphone', sentences: [
        { fr: 'Le téléphone sonne.', en: 'The phone rings.', 
          replace: 'téléphone' },
        { fr: 'Il utilise le téléphone.', en: 'He uses the phone.', 
          replace: 'téléphone' },
        { fr: 'Elle répond au téléphone.', en: 'She answers the phone.', 
          replace: 'téléphone' },
        { fr: 'Ils regardent le téléphone.', en: 'They look at the phone.', 
          replace: 'téléphone' },
        { fr: 'Nous achetons le téléphone.', en: 'We buy the phone.', 
          replace: 'téléphone' },
        { fr: 'Vous avez le téléphone?', en: 'Do you have the phone?', 
          replace: 'téléphone' }
      ]},
      { word: 'dire', sentences: [
        { fr: 'Je dis la vérité.', en: 'I tell the truth.', 
          replace: 'dis' },
        { fr: 'Il dit bonjour.', en: 'He says hello.', 
          replace: 'dit' },
        { fr: 'Elle dit au revoir.', en: 'She says goodbye.', 
          replace: 'dit' },
        { fr: 'Ils disent merci.', en: 'They say thank you.', 
          replace: 'disent' },
        { fr: 'Nous disons oui.', en: 'We say yes.', 
          replace: 'disons' },
        { fr: 'Vous dites non.', en: 'You say no.', 
          replace: 'dites' }
      ]},
      { word: 'devoir', sentences: [
        { fr: 'Je dois partir.', en: 'I must leave.', 
          replace: 'dois' },
        { fr: 'Il doit étudier.', en: 'He must study.', 
          replace: 'doit' },
        { fr: 'Elle doit manger.', en: 'She must eat.', 
          replace: 'doit' },
        { fr: 'Ils doivent travailler.', en: 'They must work.', 
          replace: 'doivent' },
        { fr: 'Nous devons essayer.', en: 'We must try.', 
          replace: 'devons' },
        { fr: 'Vous devez attendre.', en: 'You must wait.', 
          replace: 'devez' }
      ]},
      { word: 'vouloir', sentences: [
        { fr: 'Je veux manger.', en: 'I want to eat.', 
          replace: 'veux' },
        { fr: 'Il veut dormir.', en: 'He wants to sleep.', 
          replace: 'veut' },
        { fr: 'Elle veut partir.', en: 'She wants to leave.', 
          replace: 'veut' },
        { fr: 'Ils veulent rester.', en: 'They want to stay.', 
          replace: 'veulent' },
        { fr: 'Nous voulons partir.', en: 'We want to leave.', 
          replace: 'voulons' },
        { fr: 'Vous voulez venir.', en: 'You want to come.', 
          replace: 'voulez' }
      ]},
      { word: 'pouvoir', sentences: [
        { fr: 'Je peux aider.', en: 'I can help.', 
          replace: 'peux' },
        { fr: 'Il peut faire.', en: 'He can do.', 
          replace: 'peut' },
        { fr: 'Elle peut venir.', en: 'She can come.', 
          replace: 'peut' },
        { fr: 'Ils peuvent aller.', en: 'They can go.', 
          replace: 'peuvent' },
        { fr: 'Nous pouvons essayer.', en: 'We can try.', 
          replace: 'pouvons' },
        { fr: 'Vous pouvez parler.', en: 'You can speak.', 
          replace: 'pouvez' }
      ]},
      { word: 'savoir', sentences: [
        { fr: 'Je sais la réponse.', en: 'I know the answer.', 
          replace: 'sais' },
        { fr: 'Il sait parler.', en: 'He knows how to speak.', 
          replace: 'sait' },
        { fr: 'Elle sait la date.', en: 'She knows the date.', 
          replace: 'sait' },
        { fr: 'Ils savent bien.', en: 'They know well.', 
          replace: 'savent' },
        { fr: 'Nous savons faire.', en: 'We know how to do.', 
          replace: 'savons' },
        { fr: 'Vous savez dire.', en: 'You know how to say.', 
          replace: 'savez' }
      ]},
      { word: 'tenir', sentences: [
        { fr: 'Je tiens la porte.', en: 'I hold the door.', 
          replace: 'tiens' },
        { fr: 'Il tient le livre.', en: 'He holds the book.', 
          replace: 'tient' },
        { fr: 'Elle tient sa main.', en: 'She holds her hand.', 
          replace: 'tient' },
        { fr: 'Ils tiennent fort.', en: 'They hold tight.', 
          replace: 'tiennent' },
        { fr: 'Nous tenons bien.', en: 'We hold well.', 
          replace: 'tenons' },
        { fr: 'Vous tenez ça.', en: 'You hold that.', 
          replace: 'tenez' }
      ]},
      { word: 'croire', sentences: [
        { fr: 'Je crois en toi.', en: 'I believe in you.', 
          replace: 'crois' },
        { fr: 'Il croit ça.', en: 'He believes that.', 
          replace: 'croit' },
        { fr: 'Elle croit bien.', en: 'She believes well.', 
          replace: 'croit' },
        { fr: 'Ils croient facilement.', en: 'They believe easily.', 
          replace: 'croient' },
        { fr: 'Nous croyons encore.', en: 'We still believe.', 
          replace: 'croyons' },
        { fr: 'Vous croyez qui?', en: 'Who do you believe?', 
          replace: 'croyez' }
      ]},
      { word: 'sembler', sentences: [
        { fr: 'Je semble content.', en: 'I seem happy.', 
          replace: 'semble' },
        { fr: 'Il semble triste.', en: 'He seems sad.', 
          replace: 'semble' },
        { fr: 'Elle semble forte.', en: 'She seems strong.', 
          replace: 'semble' },
        { fr: 'Ils semblent prêts.', en: 'They seem ready.', 
          replace: 'semblent' },
        { fr: 'Nous semblons bons.', en: 'We seem good.', 
          replace: 'semblons' },
        { fr: 'Vous semblez occupés.', en: 'You seem busy.', 
          replace: 'semblez' }
      ]},
      { word: 'demander', sentences: [
        { fr: 'Je demande l\'heure.', en: 'I ask for the time.', 
          replace: 'demande' },
        { fr: 'Il demande pourquoi.', en: 'He asks why.', 
          replace: 'demande' },
        { fr: 'Elle demande permission.', en: 'She asks permission.', 
          replace: 'demande' },
        { fr: 'Ils demandent l\'aide.', en: 'They ask for help.', 
          replace: 'demandent' },
        { fr: 'Nous demandons ça.', en: 'We ask for that.', 
          replace: 'demandons' },
        { fr: 'Vous demandez quoi?', en: 'What do you ask?', 
          replace: 'demandez' }
      ]},
      { word: 'penser', sentences: [
        { fr: 'Je pense à toi.', en: 'I think of you.', 
          replace: 'pense' },
        { fr: 'Il pense souvent.', en: 'He thinks often.', 
          replace: 'pense' },
        { fr: 'Elle pense bien.', en: 'She thinks well.', 
          replace: 'pense' },
        { fr: 'Ils pensent beaucoup.', en: 'They think a lot.', 
          replace: 'pensent' },
        { fr: 'Nous pensons vite.', en: 'We think fast.', 
          replace: 'pensons' },
        { fr: 'Vous pensez comment?', en: 'How do you think?', 
          replace: 'pensez' }
      ]},

      // Level 10: Transportation & Travel
      { word: 'la voiture', sentences: [
        { fr: 'Ma voiture est rouge.', en: 'My car is red.', 
          replace: 'voiture' },
        { fr: 'Il conduit sa voiture.', en: 'He drives his car.', 
          replace: 'voiture' },
        { fr: 'Elle achète une voiture.', en: 'She buys a car.', 
          replace: 'voiture' },
        { fr: 'Ils réparent leurs voitures.', en: 'They repair their cars.', 
          replace: 'voitures' },
        { fr: 'Nous lavons la voiture.', en: 'We wash the car.', 
          replace: 'voiture' },
        { fr: 'Vous avez quelle voiture?', en: 'What car do you have?', 
          replace: 'voiture' }
      ]},
      { word: 'le train', sentences: [
        { fr: 'Le train arrive à l\'heure.', en: 'The train arrives on time.', 
          replace: 'train' },
        { fr: 'Il prend le train.', en: 'He takes the train.', 
          replace: 'train' },
        { fr: 'Elle attend le train.', en: 'She waits for the train.', 
          replace: 'train' },
        { fr: 'Ils voyagent en train.', en: 'They travel by train.', 
          replace: 'train' },
        { fr: 'Nous aimons le train.', en: 'We like the train.', 
          replace: 'train' },
        { fr: 'Vous préférez le train?', en: 'Do you prefer the train?', 
          replace: 'train' }
      ]},
      { word: 'l\'avion', sentences: [
        { fr: 'L\'avion décolle.', en: 'The airplane takes off.', 
          replace: 'avion' },
        { fr: 'Il voyage en avion.', en: 'He travels by plane.', 
          replace: 'avion' },
        { fr: 'Elle regarde l\'avion.', en: 'She watches the plane.', 
          replace: 'avion' },
        { fr: 'Ils prennent l\'avion.', en: 'They take the plane.', 
          replace: 'avion' },
        { fr: 'Nous volons en avion.', en: 'We fly by plane.', 
          replace: 'avion' },
        { fr: 'Vous avez peur de l\'avion?', en: 'Are you afraid of flying?', 
          replace: 'avion' }
      ]},
      { word: 'le bus', sentences: [
        { fr: 'Le bus est en retard.', en: 'The bus is late.', 
          replace: 'bus' },
        { fr: 'Il monte dans le bus.', en: 'He gets on the bus.', 
          replace: 'bus' },
        { fr: 'Elle descend du bus.', en: 'She gets off the bus.', 
          replace: 'bus' },
        { fr: 'Ils attendent le bus.', en: 'They wait for the bus.', 
          replace: 'bus' },
        { fr: 'Nous prenons le bus.', en: 'We take the bus.', 
          replace: 'bus' },
        { fr: 'Vous connaissez ce bus?', en: 'Do you know this bus?', 
          replace: 'bus' }
      ]},
      { word: 'le vélo', sentences: [
        { fr: 'Mon vélo est bleu.', en: 'My bike is blue.', 
          replace: 'vélo' },
        { fr: 'Il fait du vélo.', en: 'He rides a bike.', 
          replace: 'vélo' },
        { fr: 'Elle achète un vélo.', en: 'She buys a bike.', 
          replace: 'vélo' },
        { fr: 'Ils réparent leurs vélos.', en: 'They repair their bikes.', 
          replace: 'vélos' },
        { fr: 'Nous aimons le vélo.', en: 'We like biking.', 
          replace: 'vélo' },
        { fr: 'Vous faites du vélo?', en: 'Do you ride a bike?', 
          replace: 'vélo' }
      ]},
      { word: 'la route', sentences: [
        { fr: 'Cette route est longue.', en: 'This road is long.', 
          replace: 'route' },
        { fr: 'Il suit la route.', en: 'He follows the road.', 
          replace: 'route' },
        { fr: 'Elle traverse la route.', en: 'She crosses the road.', 
          replace: 'route' },
        { fr: 'Ils construisent une route.', en: 'They build a road.', 
          replace: 'route' },
        { fr: 'Nous connaissons cette route.', en: 'We know this road.', 
          replace: 'route' },
        { fr: 'Vous prenez quelle route?', en: 'Which road do you take?', 
          replace: 'route' }
      ]},
      { word: 'la gare', sentences: [
        { fr: 'La gare est grande.', en: 'The station is big.', 
          replace: 'gare' },
        { fr: 'Il arrive à la gare.', en: 'He arrives at the station.', 
          replace: 'gare' },
        { fr: 'Elle attend à la gare.', en: 'She waits at the station.', 
          replace: 'gare' },
        { fr: 'Ils se retrouvent à la gare.', en: 'They meet at the station.', 
          replace: 'gare' },
        { fr: 'Nous partons de la gare.', en: 'We leave from the station.', 
          replace: 'gare' },
        { fr: 'Vous connaissez cette gare?', en: 'Do you know this station?', 
          replace: 'gare' }
      ]},
      { word: 'l\'aéroport', sentences: [
        { fr: 'L\'aéroport est moderne.', en: 'The airport is modern.', 
          replace: 'aéroport' },
        { fr: 'Il travaille à l\'aéroport.', en: 'He works at the airport.', 
          replace: 'aéroport' },
        { fr: 'Elle arrive à l\'aéroport.', en: 'She arrives at the airport.', 
          replace: 'aéroport' },
        { fr: 'Ils se perdent dans l\'aéroport.', en: 'They get lost in the airport.', 
          replace: 'aéroport' },
        { fr: 'Nous attendons à l\'aéroport.', en: 'We wait at the airport.', 
          replace: 'aéroport' },
        { fr: 'Vous allez à l\'aéroport?', en: 'Are you going to the airport?', 
          replace: 'aéroport' }
      ]},
      { word: 'le billet', sentences: [
        { fr: 'Ce billet coûte cher.', en: 'This ticket costs a lot.', 
          replace: 'billet' },
        { fr: 'Il achète un billet.', en: 'He buys a ticket.', 
          replace: 'billet' },
        { fr: 'Elle perd son billet.', en: 'She loses her ticket.', 
          replace: 'billet' },
        { fr: 'Ils réservent leurs billets.', en: 'They reserve their tickets.', 
          replace: 'billets' },
        { fr: 'Nous gardons nos billets.', en: 'We keep our tickets.', 
          replace: 'billets' },
        { fr: 'Vous avez votre billet?', en: 'Do you have your ticket?', 
          replace: 'billet' }
      ]},
      { word: 'voyager', sentences: [
        { fr: 'Je voyage souvent.', en: 'I travel often.', 
          replace: 'voyage' },
        { fr: 'Il voyage en Europe.', en: 'He travels in Europe.', 
          replace: 'voyage' },
        { fr: 'Elle voyage seule.', en: 'She travels alone.', 
          replace: 'voyage' },
        { fr: 'Ils voyagent ensemble.', en: 'They travel together.', 
          replace: 'voyagent' },
        { fr: 'Nous voyageons demain.', en: 'We travel tomorrow.', 
          replace: 'voyageons' },
        { fr: 'Vous voyagez où?', en: 'Where do you travel?', 
          replace: 'voyagez' }
      ]},
      { word: 'conduire', sentences: [
        { fr: 'Je conduis prudemment.', en: 'I drive carefully.', 
          replace: 'conduis' },
        { fr: 'Il conduit vite.', en: 'He drives fast.', 
          replace: 'conduit' },
        { fr: 'Elle conduit bien.', en: 'She drives well.', 
          replace: 'conduit' },
        { fr: 'Ils conduisent ensemble.', en: 'They drive together.', 
          replace: 'conduisent' },
        { fr: 'Nous conduisons demain.', en: 'We drive tomorrow.', 
          replace: 'conduisons' },
        { fr: 'Vous conduisez souvent?', en: 'Do you drive often?', 
          replace: 'conduisez' }
      ]},
      { word: 'prendre', sentences: [
        { fr: 'Je prends le train.', en: 'I take the train.', 
          replace: 'prends' },
        { fr: 'Il prend son temps.', en: 'He takes his time.', 
          replace: 'prend' },
        { fr: 'Elle prend des photos.', en: 'She takes photos.', 
          replace: 'prend' },
        { fr: 'Ils prennent le bus.', en: 'They take the bus.', 
          replace: 'prennent' },
        { fr: 'Nous prenons le métro.', en: 'We take the subway.', 
          replace: 'prenons' },
        { fr: 'Vous prenez quoi?', en: 'What do you take?', 
          replace: 'prenez' }
      ]},
      { word: 'monter', sentences: [
        { fr: 'Je monte dans le bus.', en: 'I get on the bus.', 
          replace: 'monte' },
        { fr: 'Il monte l\'escalier.', en: 'He goes up the stairs.', 
          replace: 'monte' },
        { fr: 'Elle monte à cheval.', en: 'She rides a horse.', 
          replace: 'monte' },
        { fr: 'Ils montent ensemble.', en: 'They go up together.', 
          replace: 'montent' },
        { fr: 'Nous montons demain.', en: 'We go up tomorrow.', 
          replace: 'montons' },
        { fr: 'Vous montez où?', en: 'Where do you go up?', 
          replace: 'montez' }
      ]},
      { word: 'descendre', sentences: [
        { fr: 'Je descends du train.', en: 'I get off the train.', 
          replace: 'descends' },
        { fr: 'Il descend l\'escalier.', en: 'He goes down the stairs.', 
          replace: 'descend' },
        { fr: 'Elle descend vite.', en: 'She goes down quickly.', 
          replace: 'descend' },
        { fr: 'Ils descendent ensemble.', en: 'They go down together.', 
          replace: 'descendent' },
        { fr: 'Nous descendons ici.', en: 'We get off here.', 
          replace: 'descendons' },
        { fr: 'Vous descendez où?', en: 'Where do you get off?', 
          replace: 'descendez' }
      ]},
      { word: 'arriver', sentences: [
        { fr: 'J\'arrive à l\'heure.', en: 'I arrive on time.', 
          replace: 'arrive' },
        { fr: 'Il arrive demain.', en: 'He arrives tomorrow.', 
          replace: 'arrive' },
        { fr: 'Elle arrive en retard.', en: 'She arrives late.', 
          replace: 'arrive' },
        { fr: 'Ils arrivent ensemble.', en: 'They arrive together.', 
          replace: 'arrivent' },
        { fr: 'Nous arrivons bientôt.', en: 'We arrive soon.', 
          replace: 'arrivons' },
        { fr: 'Vous arrivez quand?', en: 'When do you arrive?', 
          replace: 'arrivez' }
      ]},
      { word: 'explorer', sentences: [
        { fr: 'J\'explore la ville.', en: 'I explore the city.', 
          replace: 'explore' },
        { fr: 'Il explore la nature.', en: 'He explores nature.', 
          replace: 'explore' },
        { fr: 'Elle explore le monde.', en: 'She explores the world.', 
          replace: 'explore' },
        { fr: 'Ils explorent ensemble.', en: 'They explore together.', 
          replace: 'explorent' },
        { fr: 'Nous explorons demain.', en: 'We explore tomorrow.', 
          replace: 'explorons' },
        { fr: 'Vous explorez quoi?', en: 'What do you explore?', 
          replace: 'explorez' }
      ]},
      { word: 'réserver', sentences: [
        { fr: 'Je réserve une table.', en: 'I reserve a table.', 
          replace: 'réserve' },
        { fr: 'Il réserve un hôtel.', en: 'He reserves a hotel.', 
          replace: 'réserve' },
        { fr: 'Elle réserve ses billets.', en: 'She reserves her tickets.', 
          replace: 'réserve' },
        { fr: 'Ils réservent ensemble.', en: 'They reserve together.', 
          replace: 'réservent' },
        { fr: 'Nous réservons demain.', en: 'We reserve tomorrow.', 
          replace: 'réservons' },
        { fr: 'Vous réservez quoi?', en: 'What do you reserve?', 
          replace: 'réservez' }
      ]},
      { word: 'chercher', sentences: [
        { fr: 'Je cherche mes clés.', en: 'I look for my keys.', 
          replace: 'cherche' },
        { fr: 'Il cherche un travail.', en: 'He looks for a job.', 
          replace: 'cherche' },
        { fr: 'Elle cherche ses lunettes.', en: 'She looks for her glasses.', 
          replace: 'cherche' },
        { fr: 'Ils cherchent ensemble.', en: 'They look together.', 
          replace: 'cherchent' },
        { fr: 'Nous cherchons demain.', en: 'We look tomorrow.', 
          replace: 'cherchons' },
        { fr: 'Vous cherchez quoi?', en: 'What are you looking for?', 
          replace: 'cherchez' }
      ]},
      { word: 'trouver', sentences: [
        { fr: 'Je trouve mes clés.', en: 'I find my keys.', 
          replace: 'trouve' },
        { fr: 'Il trouve un travail.', en: 'He finds a job.', 
          replace: 'trouve' },
        { fr: 'Elle trouve ses lunettes.', en: 'She finds her glasses.', 
          replace: 'trouve' },
        { fr: 'Ils trouvent ensemble.', en: 'They find together.', 
          replace: 'trouvent' },
        { fr: 'Nous trouvons demain.', en: 'We find tomorrow.', 
          replace: 'trouvons' },
        { fr: 'Vous trouvez quoi?', en: 'What do you find?', 
          replace: 'trouvez' }
      ]}
    ];
